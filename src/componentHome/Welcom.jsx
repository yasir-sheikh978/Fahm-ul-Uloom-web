...
export default function Welcom() {
  return (
    <div className="bg-gray-200 py-16   ">
      <h1 className="text-4xl md:text-6xl playfair font-bold text-center  pb-2" data-aos="zoom-in">
      ...
      <div className="p-6 geist leading-6 md:leading-9 text-sm md:text-xl  border-2 border-black rounded-lg shadow-xl bg-gray-100  shadow-gray-700 mx-auto max-w-4xl" data-aos="flip-left"
