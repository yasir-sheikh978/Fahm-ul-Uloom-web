    ...
    return (
        <div className='container my-16 bg-white dark:bg-gray-900 dark:text-white'>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                <motion.div variants={fadeanimation(0.5)} initial="initial" whileInView="animate" className='mx-0 md:mx-8 px-6 py-10 space-y-4 shadow-lg border-t-8 border-green-800 dark:bg-slate-800'>
                    <h1 className='text-2xl font-semibold text-center text-yellow-800'>Make your children scholars (Alim)</h1>
                    <div>
                        <p className="text-center font-semibold">
                            :      قال رسول الله    ﷺ
                        </p>
                        <p className="quranic-text text-center break-words">إِنَّ مِنْ أَبَرِّ صَدَقَاتِ الْمَرْءِ عَلَيْهِ أَنْ يُعَلِّمَ وَلَدَهُ وَيُدَّرِبَهُ عَلَى الْمَعَارِفِ وَيُفِيضَ عَلَيْهِ مِنْ أَنْوَاعِ الْعِلْمِ</p>
                ...
                <motion.div variants={fadeanimation(0.4)} initial="initial" whileInView="animate" className='mx-0 md:mx-8 px-6 py-10 space-y-4 shadow-lg border-t-8 border-yellow-500 dark:bg-slate-800'>
                <h1 className='text-2xl font-semibold text-center text-green-700'>The Reward and Blessings of Teaching Knowledge</h1>
                    <div>
                        <p className="text-center font-semibold">
                        قَــالَ رَسُــولُ الـلَّـهِ ﷺ  </p>
                        <p className="quranic-text text-center break-words">  مَـنْ دَلَّ عَـلَـىٰ خَـيْـرٍ فَـلَـهُ مِـثْـلُ أَجْـرِ فَـاعِـلِـهِ </p>
